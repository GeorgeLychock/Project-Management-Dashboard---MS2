...
#### Story 1
As a logged in project manager, I want to see key project status metrics on my current projects, so that I have a clear one stop look at all overall program status.
-   Acceptance Criteria -- Duplicated in Testing section below
    ...
    -   I can see further detail of a given project in a Project Dashboard.
